...
<>
<footer className="bg-[#060018] font-sara">
  <div className="max-w-6xl py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
      ...
      <img className="mx-auto h-10 w-auto" src="https://assets.valorantesports.com/val/vct-logo.21d0c9ddeb.svg" alt="valorant champs"/>
        ...
        <h4 className="font-medium text-gray-100">About</h4>

        <div className="mt-3 grid space-y-3">
          <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Pricing</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">CTA</a></p>
      ...
      <div className="col-span-1">
        ...
        <div className="mt-3 grid space-y-3">
          ...
          <p><a className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Careers</a> <span className="inline ml-1 text-xs bg-[#331391] text-white py-1 px-2 rounded-md">We're hiring</span></p>
      ...
      <div className="col-span-2">
        <h4 className="font-medium text-gray-100">Stay up to date</h4>
        ...
        <form>
          ...
          <p className="mt-3 text-sm text-gray-400">
            New tournaments or big prizepool tournament comming soon. Never spam.
          </p>
        </form>
      </div>
    ...
    <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-400">© VCT CHAMPIONS 2024. All rights reserved.</p>
      </div>
